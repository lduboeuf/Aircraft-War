...
//        }
        ...
        function backButton(){
            ...
            Qt.quit()
//            if(double_text.text == "Press again to exit")
//            {
//                Qt.quit()
//            }else{
//                double_text.text = "Press again to exit"
//                time_quit.start()
//            }
        }
...
//            id:time_quit
//            interval: 2000
//            onTriggered: double_text.text = "Double tap on the screen to start the game"
//        }
        Music{id:music}//音乐播放
...
//            }
            ...
            Image{
                id:gameStartBtn
                source:gamestartmouse.pressed? "qrc:/Image/button_2_2.png": "qrc:/Image/button_2_1.png"
                scale: main.height!=640?1:0.75
                smooth: true
                anchors.horizontalCenter: parent.horizontalCenter
                //x:parent.width/4-width/2
                y:parent.height - (parent.height / 3 + height)
                Text{
                    color: "#303030"
...
//                    font.pointSize: 18
//                    font.bold: true
//                    text:"Double tap on the screen to start the game"
//                }
